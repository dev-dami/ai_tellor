...
export namespace Prisma {
  ...
  */
  ...
  export interface LeadDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * const leadWithChatIdOnly = await prisma.lead.findMany({ select: { chatId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Leads and only return the `chatId`
     * const leadWithChatIdOnly = await prisma.lead.createManyAndReturn({ 
     *   select: { chatId: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  interface LeadFieldRefs {
    readonly chatId: FieldRef<"Lead", 'String'>
    readonly phone: FieldRef<"Lead", 'String'>
    readonly history: FieldRef<"Lead", 'String'>
    readonly lastMessageAt: FieldRef<"Lead", 'DateTime'>
    readonly followup1: FieldRef<"Lead", 'Boolean'>
    readonly followup2: FieldRef<"Lead", 'Boolean'>
    readonly paid: FieldRef<"Lead", 'Boolean'>
  ...
  export type LeadWhereInput = {
    ...
    chatId?: StringFilter<"Lead"> | string
    phone?: StringFilter<"Lead"> | string
    history?: StringFilter<"Lead"> | string
    lastMessageAt?: DateTimeFilter<"Lead"> | Date | string
    followup1?: BoolFilter<"Lead"> | boolean
    followup2?: BoolFilter<"Lead"> | boolean
    paid?: BoolFilter<"Lead"> | boolean
  ...
  export type LeadScalarWhereWithAggregatesInput = {
    ...
    chatId?: StringWithAggregatesFilter<"Lead"> | string
    phone?: StringWithAggregatesFilter<"Lead"> | string
    history?: StringWithAggregatesFilter<"Lead"> | string
    lastMessageAt?: DateTimeWithAggregatesFilter<"Lead"> | Date | string
    followup1?: BoolWithAggregatesFilter<"Lead"> | boolean
    followup2?: BoolWithAggregatesFilter<"Lead"> | boolean
    paid?: BoolWithAggregatesFilter<"Lead"> | boolean
  ...
  export type LeadUpdateInput = {
    ...
    followup1?: BoolFieldUpdateOperationsInput | boolean
    followup2?: BoolFieldUpdateOperationsInput | boolean
